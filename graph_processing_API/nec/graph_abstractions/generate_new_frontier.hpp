                                                 ...
                                                 FilterCondition &&filter_cond)
{
    ...
    ExtendedCSRGraph *graph_ptr = _graph.get_direction_graph_ptr(current_traversal_direction);
    ...
    INNER_WALL_TIME += tm_flags.get_time();
    INNER_GNF_TIME += tm_copy_if.get_time();
