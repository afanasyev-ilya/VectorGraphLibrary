                                                 ...
                                                 FilterCondition &&filter_cond)
{
    ...
    _frontier.vector_core_part_size = estimate_sorted_frontier_part_size(_frontier, vertex_pointers, ve_threshold, vc_threshold, filter_cond);
    _frontier.collective_part_size = estimate_sorted_frontier_part_size(_frontier, vertex_pointers, vc_threshold, vertices_count, filter_cond);
