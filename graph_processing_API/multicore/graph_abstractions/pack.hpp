...
template <typename _T1, typename _T2>
void GraphAbstractionsMulticore::pack_vertices_arrays(VerticesArray<VGL_PACK_TYPE> &_packed_data,
                                                ...
                                                VerticesArray<_T2> &_second)
{
    ...
    if(size != _first.size())
        throw "Error in GraphAbstractionsMulticore::pack_vertices_arrays : non-equal sizes of input arrays";
...
template <typename _T1, typename _T2>
void GraphAbstractionsMulticore::unpack_vertices_arrays(VerticesArray<VGL_PACK_TYPE> &_packed_data,
                                                  VerticesArray<_T1> &_first,
                                                  VerticesArray<_T2> &_second)
{
    VGL_PACK_TYPE *packed_ptr = _packed_data.get_ptr();
    ...
    int size = _packed_data.size();
    if(size != _first.size())
        throw "Error in GraphAbstractionsMulticore::unpack_vertices_arrays : non-equal sizes of input arrays";
    if(size != _second.size())
        throw "Error in GraphAbstractionsMulticore::unpack_vertices_arrays : non-equal sizes of input arrays";
