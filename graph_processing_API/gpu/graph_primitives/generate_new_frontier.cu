                                               ...
                                               Condition &&cond)
{
    ...
    cout << "size: " << _frontier.size() << " vs " << _graph.get_vertices_count() << endl;
    cout << "GNF time: " << (t2 - t1)*1000.0 << " ms" << endl;
    cout << "kernel BW: " << sizeof(int)*2.0*work/(kernel_time*1e9) << " GB/s" << endl;
    cout << "thrust BW: " << sizeof(int)*2.0*work/(thrust_time*1e9) << " GB/s" << endl;
    cout << "GNF BW: " << sizeof(int)*4.0*work/((t2-t1)*1e9) << " GB/s" << endl << endl;
    #endif
}
