...
#ifndef shard_vect_CSR_h
#define shard_vect_CSR_h

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#include "shard_vect_CSR_pointer_data.h"

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

#define VECTOR_LENGTH_IN_SHARD 256

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

template <typename _TEdgeWeight>
class ShardVectCSR : public ShardBase<_TEdgeWeight>
{
private:
...
public:
    ...
    ShardVectCSRPointerData<_TEdgeWeight> get_pointers_data();
