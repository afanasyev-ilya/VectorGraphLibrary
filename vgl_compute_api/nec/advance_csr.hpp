...
template <typename EdgeOperation, typename VertexPreprocessOperation,
        typename VertexPostprocessOperation>
void GraphAbstractionsNEC::vertex_group_advance_sparse_single_core(CSRVertexGroup &_group_data,
                                                       long long *_vertex_pointers,
                                                       int *_adjacent_ids,
                                                       EdgeOperation edge_op,
                                                       VertexPreprocessOperation vertex_preprocess_op,
                                                       ...
                                                       long long _process_shift)
{
    ...
    cout << _group_data.neighbours * INT_ELEMENTS_PER_EDGE*sizeof(int) / ((t2 - t1)*1e9) << " GB/s band on sc advance" << endl;
}
