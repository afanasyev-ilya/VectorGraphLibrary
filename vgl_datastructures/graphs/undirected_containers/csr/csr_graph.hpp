...
void CSRGraph::save_main_content_to_binary_file(FILE *_graph_file)
{
    ...
    fwrite(reinterpret_cast<const char*>(&(this->graph_type)), sizeof(GraphType), 1, _graph_file);
...
void CSRGraph::load_main_content_from_binary_file(FILE *_graph_file)
{
    ...
    fread(reinterpret_cast<char*>(&(this->graph_type)), sizeof(GraphType), 1, _graph_file);
