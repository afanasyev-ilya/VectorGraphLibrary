...
bool ShardedCSRGraph::save_to_binary_file(string _file_name)
{
    ...
    fwrite(reinterpret_cast<const char*>(&(this->get_format)), sizeof(GraphStorageFormat), 1, graph_file);
...
bool ShardedCSRGraph::load_from_binary_file(string _file_name)
{
    ...
    fread(reinterpret_cast<char*>(&(this->get_format)), sizeof(GraphStorageFormat), 1, graph_file);
