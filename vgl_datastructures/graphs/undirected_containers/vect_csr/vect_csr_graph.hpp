...
{
    this->graph_format = VECTOR_CSR_GRAPH;
...
void VectorCSRGraph::save_main_content_to_binary_file(FILE *_graph_file)
{
    ...
    fwrite(reinterpret_cast<void*>(&this->graph_format), sizeof(GraphStorageFormat), 1, _graph_file);
...
void VectorCSRGraph::load_main_content_from_binary_file(FILE *_graph_file)
{
    ...
    fread(reinterpret_cast<void*>(&this->graph_format), sizeof(GraphStorageFormat), 1, _graph_file);
