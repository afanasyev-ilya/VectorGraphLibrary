...
void always_active(UndirectedGraph &_graph,
...
template<typename _TVertexValue, typename _TEdgeWeight>
void active_passive_inner(UndirectedGraph &_graph,
                          GraphPrimitivesGPU &graph_API,
                          FrontierGPU &frontier,
                          int *new_ptr,
                          int *gathered_labels,
...
template<typename _TVertexValue, typename _TEdgeWeight>
void label_changed_on_previous_iteration(UndirectedGraph &_graph,
                                         GraphPrimitivesGPU &graph_API,
                                         FrontierGPU &frontier,
                                         int *new_ptr,
                                         int *gathered_labels,
...
template<typename _TVertexValue, typename _TEdgeWeight>
void label_changed_recently(UndirectedGraph &_graph,
                            GraphPrimitivesGPU &graph_API,
                            FrontierGPU &frontier,
                            int *new_ptr,
                            int *gathered_labels,
