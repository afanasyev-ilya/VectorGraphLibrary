...
void always_active(VectorCSRGraph &_graph,
                   GraphAbstractionsGPU &graph_API,
                   VGL_Frontier &frontier,
                   int *new_ptr,
                   int *gathered_labels,
                   int *_labels,
                   int *updated,
...
template<typename _TVertexValue, typename _TEdgeWeight>
void active_passive_inner(VectorCSRGraph &_graph,
                          GraphAbstractionsGPU &graph_API,
                          VGL_Frontier &frontier,
                          int *new_ptr,
                          int *gathered_labels,
                          ...
                          int _iterations_count)
{
    ...
    auto set_all_neighbours_active = [_labels, node_states, different_presence, freqs] __device__(int src_id, int dst_id, int local_edge_pos, long long int global_edge_pos, int position_in_frontier)
    {
...
template<typename _TVertexValue, typename _TEdgeWeight>
void label_changed_on_previous_iteration(VectorCSRGraph &_graph,
                                         GraphAbstractionsGPU &graph_API,
                                         VGL_Frontier &frontier,
                                         int *new_ptr,
                                         int *gathered_labels,
...
template<typename _TVertexValue, typename _TEdgeWeight>
void label_changed_recently(VectorCSRGraph &_graph,
                            GraphAbstractionsGPU &graph_API,
                            VGL_Frontier &frontier,
                            int *new_ptr,
                            int *gathered_labels,
