...
public:
    ...
    void seq_lp(UndirectedVectCSRGraph &_graph, int *_labels, int _max_iterations = LP_DEFAULT_MAX_ITERATIONS);

    #ifdef __USE_GPU__
    void gpu_lp(UndirectedVectCSRGraph &_graph, int *_labels,
