...
void man_opt_nec_bfs(VectCSRGraph &_graph, VerticesArray<int> &levels, int _source_vertex)
{
    double t1, t2, t3, t4;
    int vertices_count    = _graph.get_vertices_count();
    long long edges_count = _graph.get_edges_count   ();
    long long    *outgoing_ptrs    = _graph.get_vertex_pointers   ();
    int          *outgoing_ids     = _graph..get_adjacent_ids    ();

    int *_levels = levels.get_ptr();
