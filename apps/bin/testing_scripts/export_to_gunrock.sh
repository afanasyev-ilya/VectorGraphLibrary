...
./generate_test_data -push -directed -s 20 -e 32 -type ru -file ./gunrock_graphs/dir_ru_20_32 -format mtx
./generate_test_data -push -directed -s 21 -e 32 -type ru -file ./gunrock_graphs/dir_ru_21_32 -format mtx
./generate_test_data -push -directed -s 22 -e 32 -type ru -file ./gunrock_graphs/dir_ru_22_32 -format mtx
./generate_test_data -push -directed -s 23 -e 32 -type ru -file ./gunrock_graphs/dir_ru_23_32 -format mtx
./generate_test_data -push -directed -s 24 -e 32 -type ru -file ./gunrock_graphs/dir_ru_24_32 -format mtx
./generate_test_data -push -directed -s 25 -e 32 -type ru -file ./gunrock_graphs/dir_ru_25_32 -format mtx
...
./generate_test_data  -directed -push -convert ./source_graphs/friendster/out.friendster  -file ./gunrock_graphs/friendster -format mtx
